...
if __name__ == "__main__":
    ...
    if parser.getboolean("DEFAULT", "AutoShard"):
        ...
        bot = commands.AutoShardedBot(command_prefix=default_prefixes, intents=discord.Intents.all())
    else:
        bot = commands.Bot(command_prefix=default_prefixes, intents=discord.Intents.all())
